...
import { Veo4kVideoNodeData } from "@/types";

type Veo4kNodeType = Node<Veo4kVideoNodeData, "veo4kVideo">;

export function Veo4kVideoNode({ id, data, selected }: NodeProps<Veo4kNodeType>) {
  const nodeData = data;
        ...
        {nodeData.outputVideo ? (
          ...
          <div className="w-full flex-1 min-h-[96px] border border-dashed border-neutral-600 rounded flex items-center justify-center">
            {nodeData.status === "loading" ? (
              <span className="text-[10px] text-neutral-400">Fetching 4K...</span>
