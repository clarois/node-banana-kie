...
const KIE_MODELS: ProviderModel[] = [
  ...
  },
  {
    ...
    description: "Google Nano Banana image editing via Kie.ai. Supports multi-image edits with prompt guidance.",
    provider: "kie",
    capabilities: ["image-to-image"],
    coverImage: undefined,
  ...
  },
  {
    ...
    capabilities: ["text-to-video"],
    coverImage: undefined,
    pricing: { type: "per-run", amount: 0.3, currency: "USD" },
    pageUrl: "https://docs.kie.ai/veo3-api/quickstart",
  },
  {
  ...
  {
    id: "veo3-fast/reference-to-video",
    name: "Veo 3 Fast Reference",
    description: "Google Veo 3.1 fast reference-to-video generation via Kie.ai. Uses 1-3 reference images.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pricing: { type: "per-run", amount: 0.3, currency: "USD" },
  ...
  },
  {
    ...
    name: "Veo 3 Extend",
    description: "Extend an existing Veo 3.1 task with a new prompt.",
    provider: "kie",
    capabilities: ["text-to-video"],
    coverImage: undefined,
    pricing: { type: "per-run", amount: 0.3, currency: "USD" },
  ...
  {
    id: "veo3/get-1080p-video",
    name: "Veo 3 1080p",
    description: "Fetch a 1080p version of a Veo 3.1 task.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pricing: { type: "per-run", amount: 0.025, currency: "USD" },
    pageUrl: "https://docs.kie.ai/veo3-api/quickstart",
  },
  {
    id: "veo3/get-4k-video",
    name: "Veo 3 4K",
    description: "Fetch a 4K version of a Veo 3.1 task.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
  ...
  },
  {
    ...
    description: "OpenAI Sora 2 Pro storyboard video generation from image with multi-shot sequences. Supports up to 10 shots with custom durations (10-25s total).",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pricing: { type: "per-run", amount: 1.35, currency: "USD" },
    pageUrl: "https://docs.kie.ai/market/sora-2-pro-storyboard",
  },
];
